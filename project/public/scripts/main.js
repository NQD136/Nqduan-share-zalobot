import { handleTikTokAutoDownload } from "../../src/Nqduan-service/api-crawl/tiktok/tiktok-auto-download";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function showSettingsModal(groupId, groupName) {
    ...
    const settingsList = {
      ...
      tiktokauto: "Tự động download link TikTok",
    };
...
function updateLogs(messageData) {
  ...
  const isScrolledToBottom =
    logContent.scrollHeight - logContent.clientHeight - logContent.scrollTop <=
    100;
