...
import { sendMessageState } from "../Nqduan-service/chat-zalo/chat-style/chat-style.js";
import { getSettingName } from "../Nqduan-service/info-service/bot-info.js";
import { readGroupSettings, writeGroupSettings } from "../utils/io-json.js";

export const changeStatusConfig = async ({
  api,
  groupId,
  groupName,
  command,
